...
exports.config = () => ({
  ...
  transaction_tracer: {
    ...
    /**
     * This option controls whether usage of process.hrtime should be disabled
     * when calculating trace segment durations. When disabled, Date.now() will
     * be used instead, for a slight performance benefit.
     *
     * @env NEW_RELIC_DISABLE_HRTIME
     */
